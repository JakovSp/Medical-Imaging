...
namespace vxe {
	...
	inline std::string ToString(const DirectX::XMFLOAT3* vector)
	{
		std::stringstream ss;
	...
	inline std::string ToString(const DirectX::XMFLOAT4* vector)
	{
		std::stringstream ss;
	...
	inline std::string ToString(const DirectX::XMFLOAT4X4* matrix)
	{
		std::stringstream ss;
