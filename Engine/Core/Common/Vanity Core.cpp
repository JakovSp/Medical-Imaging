...
// Constructor for VanityCore
VanityCore::VanityCore() :
	m_screenViewport(),
...
{
	DebugPrint(string("\t\t VanityCore::Ctor ...\n"));
...
void VanityCore::CreateDeviceIndependentResources()
{
	DebugPrint(string("\t\t VanityCore::CreateDeviceIndependentResources() ...\n"));
...
void VanityCore::CreateDeviceResources()
{
	DebugPrint(string("\t\t VanityCore::CreateDeviceResources() ...\n"));
	...
	HRESULT hr = D3D11CreateDevice(
		...
		(uint32_t) featurelevels.size(),	// Size of the list above.
...
void VanityCore::SetRasterizerState()
{
	if (m_window.Get() != nullptr) {
		...
		{
			//DebugPrint(string("\t\t VanityCore::SetRasterizerState() F1 pressed...\n"));
		...
		if (bool(KeyState & CoreVirtualKeyStates::Down))
		{
			//DebugPrint(string("\t\t VanityCore::SetRasterizerState() F2 pressed...\n"));
		...
		if (bool(KeyState & CoreVirtualKeyStates::Down))
		{
			//DebugPrint(string("\t\t VanityCore::SetRasterizerState() F3 pressed...\n"));
		...
		if (bool(KeyState & CoreVirtualKeyStates::Down))
		{
			//DebugPrint(string("\t\t VanityCore::SetRasterizerState() F4 pressed...\n"));
...
ID3D11RasterizerState1* VanityCore::CreateRasterizerState(D3D11_FILL_MODE fill, D3D11_CULL_MODE cull, bool fccw)
{
...
void VanityCore::SetBlenderState()
{
...
void VanityCore::CreateWindowSizeDependentResources()
{
	DebugPrint(string("\t\t VanityCore::CreateWindowSizeDependentResources() ...\n"));
...
void VanityCore::SetWindow(CoreWindow^ window)
{
	DebugPrint(string("\t\t VanityCore::SetWindow() ... \n"));
...
void VanityCore::SetLogicalSize(Windows::Foundation::Size logicalSize)
{
...
void VanityCore::SetDpi(float dpi)
{
	if (dpi != m_dpi) {
...
void VanityCore::SetCurrentOrientation(DisplayOrientations currentOrientation)
{
...
void VanityCore::ValidateDevice()
{
...
void VanityCore::HandleDeviceLost()
{
	m_swapChain = nullptr;

	if (m_deviceNotify != nullptr) m_deviceNotify->OnDeviceLost();

	CreateDeviceResources();
	m_d2dContext->SetDpi(m_dpi, m_dpi);
	CreateWindowSizeDependentResources();

	if (m_deviceNotify != nullptr) m_deviceNotify->OnDeviceRestored();
}

// Register our DeviceNotify to be informed on device lost and creation.
void VanityCore::RegisterDeviceNotify(IDeviceNotify* deviceNotify)
{
...
void VanityCore::Present()
{
	__Once(DebugPrint(std::string("\t VanityCore::Present()... \n")));
